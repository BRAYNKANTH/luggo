      ...
      <div className="sticky top-0 z-50 bg-[#0f1923]/95 backdrop-blur border-b border-white/8 px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="flex items-center gap-1 bg-white/10 hover:bg-white/20 text-white text-[11px] font-bold px-2.5 py-2 rounded-xl transition-all"
          >
            💵 Shift Report
          </Link>
          <Link
          ...
          <Link
            href="/staff/scan"
            className="flex items-center gap-1 bg-brand text-white text-[11px] font-bold px-3 py-2 rounded-xl active:scale-95 transition-all"
          >
            <QrCode size={13} />
            Scan QR
          </Link>
