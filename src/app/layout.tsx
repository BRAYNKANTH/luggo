...
export const metadata: Metadata = {
  ...
  title: {
    template: '%s | Luggo',
    default: 'Luggo: #1 Luggage Storage in Sri Lanka — Safe & Secure',
  },
  description: 'Luggo offers safe and affordable luggage storage at hubs across Sri Lanka. Colombo Fort, BIA Airport, Kandy, Galle, Ella & more. Book online in 60s.',
  keywords: [
    'Luggo',
    'luggage storage Sri Lanka', 
    'bag storage Sri Lanka', 
    'Colombo luggage storage', 
    'Colombo Fort station storage',
    'BIA Airport Katunayake luggage',
    'Kandy city centre luggage',
    'Galle Fort luggage storage',
    'Ella Sri Lanka luggage',
    'locker service Sri Lanka',
    'safe baggage storage',
    'backpack storage Sri Lanka',
    'Hikkaduwa luggage storage',
    'Mirissa luggage storage',
    'Bentota bag storage',
    'Sigiriya luggage'
  ],
