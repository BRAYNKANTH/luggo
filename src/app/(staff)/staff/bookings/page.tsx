  ...
  if ('error' in result) {
    return (
      <div className="min-h-screen bg-[#0f1923] text-white flex flex-col items-center justify-center p-6 text-center">
        <p className="text-red-400 font-bold mb-4">Error loading bookings</p>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="flex items-center gap-4 mb-2">
          <div className="w-12 h-12 rounded-2xl bg-brand/20 flex items-center justify-center">
            <Inbox size={24} className="text-brand-light" />
          </div>
          <div>
            <h1 className="text-xl font-black">All Bookings</h1>
            <p className="text-white/40 text-xs font-bold uppercase tracking-widest">History & Records</p>
          </div>
        </div>
